...
public class Tester
{
    ...
    public void testLogAnalyzer() {
        ...
        logAnalyzer.readFile("resources/weblogs/weblog3-short_log");
        logAnalyzer.printAll();
        System.out.println("Number of unique IPs: " + logAnalyzer.countUniqueIPs());
        logAnalyzer.printAllHigherThanNum(404);
        Iterator<String> it = logAnalyzer.uniqueIPVisitsDay("Mar 17").iterator();
        while (it.hasNext()) {
            System.out.println(it.next());
        }
        System.out.println(logAnalyzer.uniqueIPVisitsDay("Mar 17").size());
