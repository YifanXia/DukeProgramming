...
public class CaesarCracker {
    ...
    public static void main(String[] args) {
        CaesarCipher caesarCipher = new CaesarCipher(15);
        CaesarCracker caesarCracker = new CaesarCracker();
        String om = new FileResource("src/Course2/Vigenere/test_data/titus-small_key5.txt").asString();
        String em = caesarCipher.encrypt(om);
        String dm = caesarCracker.decrypt(em);
